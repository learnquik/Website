		...
		<div class="container py-xl-5 py-lg-3">
			...
			<div class="row about-head-wthree">
				...
				<div class="col-lg-6 right-abw3ls mt-lg-0 mt-sm-5 mt-4">
					...
					<p>We are a group of Intellectuals and Engineers  who are ready to provide you the Best and Qualified Teachers at your Home.We focus on quality of teachers.We are in teaching at a very early stage and have seen that there are many problems for the students of medium classes as they are not getting good teachers.As a result the students are unable to achieve their dream goal.To remove these problems we are here to provide you the best teachers.  </p>
					<p class="mt-3">.</p>
				</div>
			</div>
		</div>
		...
		<div class="container-fluid py-xl-5 py-lg-3">
			<div class="row about-head-wthree-2">
				...
				<div class="col-lg-4 right-abw3ls my-lg-0 my-sm-5 my-4">
					...
					<p>Our Short term Mission to Contact at least 1000 students/Parents and 300 teachers in one year since 2020. </p>
					<p class="mt-3">Our long term goal is to contact One lac Students/Parents and 10000 teachers in Coming Five Years.</p>
				</div>
				<div class="col-lg-4 left-abw3ls text-lg-left text-center">
