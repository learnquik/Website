...
if(isset($_POST['submit']))
{
	$email=$_POST['email'];
$pass=$_POST['pass'];
$$que=mysqli_query($con,"select * from student where email='$email'");	
...
<head>
	<title>Learnquik|Students's Login</title>
	<!-- Meta tag Keywords -->
...
<body>
	...
	<div class="login-w3ls py-5">
		<div class="container py-xl-5 py-lg-3">
			<h3 class="title text-capitalize font-weight-light text-dark text-center mb-5">Student's
