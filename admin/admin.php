     ...
     <!-- Navigation -->
        <nav class="top1 navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="admin.php" class="text-dark"><b>LEarnQuik  ||Welcome   <?php
                 echo $email ?></b></a>
            </div>
            <!-- /.navbar-header
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="#"><i class="fa fa-envelope nav_icon"></i>Student's Applications<span class="fa arrow"></span></a>
                        ...
                        <li>
                            <a href="#"><i class="fa fa-envelope nav_icon"></i>Teacher's Applications<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="app1.php">Application</a>
                                </li>
                        ...
                        <li>
                            <a href="#"><i class="fa fa-envelope nav_icon"></i>Matching Applications<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="app2.php">Application</a>
                                </li>
        ...
        $num1=mysqli_num_rows($query1);
         ...
         ?>
         <?php 
        $query2=mysqli_query($con,"select * from apply");
        $num2=mysqli_num_rows($query2);
        $query4=mysqli_query($con,"select * from apply1");
        $num3=mysqli_num_rows($query4);
         $query5=mysqli_query($con,"select * from apply inner JOIN apply1 on  apply.student_id=apply1.student_id AND apply.teacher_id=apply1.teacher_id");
          $num4=mysqli_num_rows($query5);
     	...
     	<div class="col_3">
            ...
            <div class="col-md-3 widget widget1">
                <div class="r3_counter_box">
                    ...
                    <div class="stats">
                      <h5><strong><?php echo ($num2+$num3);?></strong></h5>
        	...
        	<div class="col-md-3 widget">
        		<div class="r3_counter_box">
                    ...
                    <div class="stats">
                      <h5><strong><?php echo $num4;?></strong></h5>
