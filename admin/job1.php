...
<div id="wrapper">
     <!-- Navigation -->
        ...
        <div class="graphs">
        <div class="col_1">
            <h1 class="title text-capitalize font-weight-light text-dark text-center mb-5">Teacher's
...
<div class="card">
  <img src="../images/teacher_photo/<?php echo $img;?>" alt="No Image Found" style="height:200px; width:335px;">
  <div class="content">
  ...
  <p><a href="apply1.php?id=<?php echo $id;?>"><button style="background: #42a5f5;">Apply</button></a></p>
</div></div>
<?php } ?>
</div></div>
      <div class="copy">
