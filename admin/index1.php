...
<div id="wrapper">
     <!-- Navigation -->
        ...
        $num1=mysqli_num_rows($query1);
         ...
         ?>
         <?php 
        $query2=mysqli_query($con,"select * from apply1 where student_name='$email'");
        $num2=mysqli_num_rows($query2);

         ?>
         <?php 
        $query3=mysqli_query($con,"select * from student where email='$email'");
