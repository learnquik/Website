     ...
     <!-- Navigation -->
        <nav class="top1 navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.html" style="font-size:100%;margin-bottom:10px;">Teacher's Admin Panel || LEarnQuik</a>
            </div>
            <!-- /.navbar-header 
        ...
        <div class="graphs">
        <div class="col_1">
            <h1 class="title text-capitalize font-weight-light text-dark text-center mb-5">Need's/Job
...
<div class="card">
  ...
  <p><a href="apply.php?id=<?php echo $id;?>"><button style="background: #42a5f5;">Apply</button></a></p>
</div></div>
<?php } ?>
</div></div>
      <div class="copy">
