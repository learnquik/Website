			...
			<div class="sub-main-w3 pt-md-4">
				<form action="include/reset-request.inc.php" method="post" >
					<div class="form-style-agile form-group">
						...
						<input placeholder="Enter Your Email Address" class="form-control" name="email" type="text" required="">
					</div>
					
					<!-- //switch -->
					<input type="submit" value="Receive New password by Email" name="reset-request-submit">
					<?php
	if (isset($_GET["reset"])) {
		if ($_GET["reset"]=="success") {
		echo '<h2 class="bg-success text-center text-white mt-4">Check Your E-mail</h2>';
		}
