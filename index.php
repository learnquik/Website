	...
	<div class="banner-agile">
		...
		<div class="banner-text-posi-w3ls">
			<div class="banner-text-whtree">
				<h3 class="text-capitalize text-white p-4">Get the Best
					<b>Home Tutor Online!</b>
				</h3>
				<p class="px-4 py-3 text-dark">Shape Your Career With The Help Of Highly Qualified Gurus!</p>
				<form action="teachers1.php" class="button-agiles text-capitalize text-white mt-sm-5 mt-4" method="post">
					<div class="wrap">
                  <div class="search">
                  <input type="text" class="searchTerm" placeholder="Enter your city to find teachers?" name="city1">
	...
	<div class="about py-5">
		<div class="container py-xl-5 py-lg-3">
			<h3 class="title text-capitalize font-weight-light text-dark text-center mb-5">Welcome to
				<span class="font-weight-bold">LEarnQuik</span>
			</h3>
			<div class="row pt-md-4">
				<div class="col-lg-6 about_right">
					<h3 class="text-capitalize text-right font-weight-light font-italic">find teachers according to your needs and choice at
						<span class="font-weight-bold">LEarnQuik</span>
					</h3>
					<p class="text-right my-4 pr-4 border-right">We provide students as well as parents to find the best tutor for themselves or for your son/daughter.
We provide you a variety of options of teachers and you can select the teachers according to your needs ,choice, qualification and experience.We also provides you to choose among the male and female teachers of your choice.
We are providing demo classes of teachers through which you can select the teacher of your own choice at a minimal cost.We also provide teachers to complete your whole syllabus in a limited fixed time as a crash course.We provide a facility to even hire a teacher to complete a subject or even a single chapter in which you stuck.   
</p>
					<div class="about_left-list">
						<h6 class="mb-lg-3 mb-2 font-weight-bold text-dark">Our Benefits</h6>
						<ul class="list-unstyled">
							<li class="mb-2">
								<i class="fas fa-check mr-3"></i>Easy to find best teachers of your area</li>
							<li class="mb-2">
								<i class="fas fa-check mr-3"></i>Demo classes at a minimal cost</li>
							<li class="mb-2">
								<i class="fas fa-check mr-3"></i>Highly qualified teachers at your doorstep</li>
							<li class="mb-2">
								<i class="fas fa-check mr-3"></i>Cost flexibility</li>

								<li class="mb-2">
								<i class="fas fa-check mr-3"></i>Flexible timings</li>
						</ul>
					</div>
				</div>
			...
			<div class="stats-info">
				<div class="row">
					...
					<div class="col-md-3 col-6 stats-grid-w3-agile text-center  px-xl-5 px-3">
						...
						<p class="text-uppercase text-white border-top pt-4 mt-3">courses</p>
					</div>
					...
					<div class="col-md-3 col-6 stats-grid-w3-agile text-center mt-md-0 mt-5  px-xl-5 px-3">
						<div class='numscroller font-weight-bold my-2' data-slno='1' data-min='0' data-max='1200' data-delay='.5' data-increment="1">1200</div>
						<p class="text-uppercase text-white border-top pt-4 mt-3">happy parents</p>
					</div>
				</div>
			</div>
		</div>
 ...
 //course -->
			...
			<div class="row agileits-w3layouts-grid pt-md-4">
				<div class="col-lg-4 services-agile-1">
					<div class="row wthree_agile_us">
						...
						<div class="col-9 agile-why-text-2">
							...
							<p class="text-white">We also provide teachers to complete your whole syllabus in a limited fixed time as a crash course.We provide a facility to even hire a teacher to complete a subject or even a single chapter in which you stuck.</p>
				...
				<div class="col-lg-4 services-agile-1 my-lg-0 my-5">
					<div class="row wthree_agile_us">
						...
						<div class="col-9 agile-why-text-2">
							<h4 class="text-capitalize text-white font-weight-bold mb-3">demo classes</h4>
							<p class="text-white">We are providing demo classes of teachers through which you can select the teacher of your own choice at a minimal cost.</p>
							<a class="btn mt-3 service-button p-0" href="about.html" role="button">Read More
								<i class="fas fa-long-arrow-alt-right ml-1"></i>
							</a>
						</div>
				...
				<div class="col-lg-4 services-agile-1">
					<div class="row wthree_agile_us">
						...
						<div class="col-9 agile-why-text-2">
							...
							<p class="text-white">We provide you a variety of options of teachers and you can select the teachers according to your needs ,choice and their qualification and experience.</p>
							<a class="btn mt-3 service-button p-0" href="about.html" role="button">Read More
								<i class="fas fa-long-arrow-alt-right ml-1"></i>
							</a>
						</div>
			...
			<div class="row agileits-w3layouts-grid mt-5">
				<div class="col-lg-4 services-agile-1">
					<div class="row wthree_agile_us">
						...
						<div class="col-9 agile-why-text-2">
							<h4 class="text-capitalize text-white font-weight-bold mb-3">events and seminars</h4>
							<p class="text-white">We conduct seminars in different cities for their proper career guidance.</p>
							<a class="btn mt-3 service-button p-0" href="about.html" role="button">Read More
								<i class="fas fa-long-arrow-alt-right ml-1"></i>
							</a>
						</div>
				...
				<div class="col-lg-4 services-agile-1  my-lg-0 my-5">
					<div class="row wthree_agile_us">
						...
						<div class="col-9 agile-why-text-2">
							<h4 class="text-capitalize text-white font-weight-bold mb-3">online doubt sessions</h4>
							<p class="text-white">We provide students to clear doubts online wit the experts.</p>
							<a class="btn mt-3 service-button p-0" href="about.html" role="button">Read More
								<i class="fas fa-long-arrow-alt-right ml-1"></i>
							</a>
						</div>
				...
				<div class="col-lg-4 services-agile-1">
					<div class="row wthree_agile_us">
						...
						<div class="col-9 agile-why-text-2">
							...
							<p class="text-white">We provide call assistance to you if you are having any problem with your teachers.</p>
							<a class="btn mt-3 service-button p-0" href="about.html" role="button">Read More
								<i class="fas fa-long-arrow-alt-right ml-1"></i>
							</a>
						</div>
	...
	<div class="testimonials py-5">
		<div class="container py-xl-5 py-lg-3">
			<h3 class="title text-capitalize font-weight-light text-white text-center mb-5">what 
